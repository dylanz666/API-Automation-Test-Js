/**Created by Dylan*/
module.exports = async function (apiPath, filePath, additionalHeader) {
    ...
    try {
        ...
        let creationType = path.basename(filePath, '.xlsx');
        let fields = {};
        if (creationType.toLowerCase().indexOf('lead') > -1) {
            fields.selectedFileSource = creationType;
        }
